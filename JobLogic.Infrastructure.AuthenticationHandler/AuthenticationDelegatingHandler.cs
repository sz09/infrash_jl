...
namespace JobLogic.Infrastructure.AuthenticationHandler
{
    ...
    {
        //private const string TokenEndpoint = "connect/token";//todo: change the Endpoint to be injectable
        ...
        public AuthenticationDelegatingHandler(
            ...
            string identityAuthority, string tokenEndpoint)
            : this(accessTokensCacheManager,
                clientCredentials,
                new HttpClient {BaseAddress = new Uri(identityAuthority)}, tokenEndpoint)
        {
        }
        ...
        public AuthenticationDelegatingHandler(
            AccessTokensCacheManager accessTokensCacheManager,
            ClientCredentials clientCredentials,
            HttpClient accessControlHttpClient, string tokenEndpoint)
        {
